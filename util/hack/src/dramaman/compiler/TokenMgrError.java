...
/*     */   {
/*  98 */     return "Lexical error at line " + paramInt2 + ", column " + paramInt3 + ".  Encountered: " + (paramBoolean ? "<EOF> " : new StringBuffer("\"").append(addEscapes(String.valueOf(paramChar))).append("\" (").append(paramChar).append("), ").toString()) + "after : \"" + addEscapes(paramString) + '"';
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Program Files (x86)\Extérieur\util\classes\!\dramaman\compiler\TokenMgrError.class
