...
/*     */ 
/*     */ public abstract class ObjectPickupPositionSensor extends FacadeSensor implements facade.util.SpriteID
/*     */ {
...
/*     */   {
/*  17 */     this.lastPositions = new java.util.Hashtable();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*  44 */     facade.nativeinterface.NativeAnimationInterface.getAllObjectPickupPositions(paramInt, localObjectSensePacket);
/*  45 */     deleteAllOldWMEs(paramInt);
/*  46 */     addAllPickupPositionWMEs(paramInt, localObjectSensePacket);
/*     */   }
/*     */   
/*     */ 
/*     */   private final synchronized void deleteAllOldWMEs(int paramInt)
/*     */   {
/*  52 */     Object[] arrayOfObject = BehavingEntity.getBehavingEntity().lookupWME("ObjectPickupPositionWME").toArray();
/*  53 */     for (int i = 0; i < arrayOfObject.length; i++) {
/*  54 */       if (((facade.characters.wmedef.ObjectPickupPositionWME)arrayOfObject[i]).getCharacterID() == paramInt) {
/*  55 */         BehavingEntity.getBehavingEntity().deleteWME((facade.characters.wmedef.ObjectPickupPositionWME)arrayOfObject[i]);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  62 */     Object[] arrayOfObject = BehavingEntity.getBehavingEntity().lookupWME("ObjectPickupPositionWME").toArray();
/*  63 */     for (int i = 0; i < arrayOfObject.length; i++) {
/*  64 */       if ((((facade.characters.wmedef.ObjectPickupPositionWME)arrayOfObject[i]).getObjectID() == paramInt1) && (((facade.characters.wmedef.ObjectPickupPositionWME)arrayOfObject[i]).getCharacterID() == paramInt2))
/*     */       {
/*  66 */         BehavingEntity.getBehavingEntity().deleteWME((facade.characters.wmedef.ObjectPickupPositionWME)arrayOfObject[i]);
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   private final void addAllPickupPositionWMEs(int paramInt, facade.util.ObjectSensePacket paramObjectSensePacket) {
/*  72 */     for (int i = 0; i < paramObjectSensePacket.info.length; i++) {
/*  73 */       BehavingEntity.getBehavingEntity().addWME(new facade.characters.wmedef.ObjectPickupPositionWME(paramObjectSensePacket.info[i].objectID, paramInt, paramObjectSensePacket.info[i].x, paramObjectSensePacket.info[i].y, paramObjectSensePacket.info[i].z));
/*     */     }
/*     */   }
/*     */   
...
/*  80 */     facade.nativeinterface.NativeAnimationInterface.getAllObjectPickupPositions(paramInt, localObjectSensePacket);
/*  81 */     deleteAllOldWMEs(paramInt);
/*  82 */     addAllPickupPositionWMEs(paramInt, localObjectSensePacket);
/*  83 */     updateLastPickupPositions(localObjectSensePacket);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 117 */     facade.nativeinterface.NativeAnimationInterface.getAllObjectPickupPositions(paramInt, localObjectSensePacket);
/* 118 */     updateLastPickupPositionsConditionally(paramInt, localObjectSensePacket);
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     //   6: athrow
/*     */     //   7: aload_0
/*     */     //   8: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   11: dup
/*     */     //   12: astore 4
/*     */     //   14: monitorenter
/*     */     //   15: iload_1
...
/*     */     //   28: istore 7
/*     */     //   30: aload_0
/*     */     //   31: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
...
/*     */     //   0	167	0	this	ObjectPickupPositionSensor
...
/*     */   
/*     */   /* Error */
/*     */   private final void updateLastPickupPositions(facade.util.ObjectSensePacket paramObjectSensePacket)
/*     */   {
/*     */     // Byte code:
/*     */     //   0: goto +6 -> 6
/*     */     //   3: aload_2
...
/*     */     //   5: athrow
/*     */     //   6: aload_0
/*     */     //   7: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   10: dup
/*     */     //   11: astore_2
/*     */     //   12: monitorenter
/*     */     //   13: iconst_0
...
/*     */     //   36: astore 5
/*     */     //   38: aload_0
/*     */     //   39: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   42: aload 5
/*     */     //   44: invokevirtual 119	java/util/Hashtable:remove	(Ljava/lang/Object;)Ljava/lang/Object;
/*     */     //   47: pop
/*     */     //   48: aload_0
/*     */     //   49: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   52: aload 5
...
/*     */     // Local variable table:
/*     */     //   start	length	slot	name	signature
/*     */     //   0	111	0	this	ObjectPickupPositionSensor
...
/*     */   
/*     */   /* Error */
/*     */   private final void updateLastPickupPositionsConditionally(int paramInt, facade.util.ObjectSensePacket paramObjectSensePacket)
/*     */   {
/*     */     // Byte code:
/*     */     //   0: iconst_0
/*     */     //   1: istore_3
...
/*     */     //   51: iload_1
/*     */     //   52: aload 4
/*     */     //   54: invokevirtual 129	facade/sensor/ObjectPickupPositionSensor:changed	(IILfacade/util/Point3D;)Z
/*     */     //   57: ifeq +113 -> 170
/*     */     //   60: aload_0
/*     */     //   61: aload_2
...
/*     */     //   70: iload_1
/*     */     //   71: invokespecial 131	facade/sensor/ObjectPickupPositionSensor:deleteOldWMEs	(II)V
/*     */     //   74: invokestatic 63	abl/runtime/BehavingEntity:getBehavingEntity	()Labl/runtime/BehavingEntity;
/*     */     //   77: new 78	facade/characters/wmedef/ObjectPickupPositionWME
/*     */     //   80: dup
/*     */     //   81: aload_2
...
/*     */     //   106: invokespecial 108	facade/characters/wmedef/ObjectPickupPositionWME:<init>	(IIFFF)V
...
/*     */     //   118: athrow
/*     */     //   119: aload_0
/*     */     //   120: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   123: dup
/*     */     //   124: astore 5
/*     */     //   126: monitorenter
...
/*     */     //   143: astore 7
/*     */     //   145: aload_0
/*     */     //   146: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   149: aload 7
/*     */     //   151: invokevirtual 119	java/util/Hashtable:remove	(Ljava/lang/Object;)Ljava/lang/Object;
/*     */     //   154: pop
/*     */     //   155: aload_0
/*     */     //   156: getfield 18	facade/sensor/ObjectPickupPositionSensor:lastPositions	Ljava/util/Hashtable;
/*     */     //   159: aload 7
/*     */     //   161: aload 4
...
/*     */     // Local variable table:
/*     */     //   start	length	slot	name	signature
/*     */     //   0	183	0	this	ObjectPickupPositionSensor
...
/* Location:              C:\Program Files (x86)\Extérieur\util\classes\!\facade\sensor\ObjectPickupPositionSensor.class
